    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-scale-in">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900/80 shadow-xl shadow-slate-200/50 dark:shadow-black/20 p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-300/30 dark:hover:shadow-black/30 hover:-translate-y-1">
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-white mb-1">Zaloguj się</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">Wprowadź dane do konta</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-lg bg-slate-800/80 border border-slate-600/60 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-shadow duration-200"
